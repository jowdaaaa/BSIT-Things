...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($_POST['password'] == "" || $_POST['password_confirm'] == "" || $_POST['password_current'] == "" || $_POST['name'] == "") {
        ...
        if ($result->num_rows > 0) {
            ...
            echo '<meta http-equiv="refresh" content="3;url=http://localhost/finals/welcome.php" />';
        } else {
            // Redirect after 3 seconds
            echo '<meta http-equiv="refresh" content="3;url=http://localhost/finals/update.html" />';
